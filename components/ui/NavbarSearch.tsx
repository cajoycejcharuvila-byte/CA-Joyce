    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute inset-0 flex items-center bg-white/95 backdrop-blur-xl rounded-full px-4 md:px-8 z-50 shadow-glass"
        >
            ...
            <div className="overflow-y-auto flex-1 p-2">
              {query === "" ? (
                <div className="px-6 py-12 text-center text-brand-dark/50">
                  <Briefcase className="w-12 h-12 mx-auto mb-4 text-brand-dark/20" />
                  <p className="text-sm font-medium">Type to search across our India and UAE practices.</p>
                </div>
              ) : results.length > 0 ? (
